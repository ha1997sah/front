        ...
        Homme
          ...
          >
            <b-form-group
              ...
              label-for="age"
        :state="selectedDate === null ? false : true"
         ...
         #default="{ errors }"
          ...
          >
            <b-form-group
              ...
              label-for="poids"
              :state="selectedWeight === null ? false : true"
...
<script>
import {
  BSidebar, BForm,BFormFile,BFormDatepicker, BFormGroup, BFormInput, BFormInvalidFeedback, BButton,BFormRadio,BFormSelect 
} from 'bootstrap-vue'
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const karateOptions= ref(["enter",'Kata','Kumite','Groupe Kata','Groupe Kumite'])
